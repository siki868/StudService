...
class Migration(migrations.Migration):
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.AutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('grupa', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='studserviceapp.Grupa')),
            ],
            options={
        ...
        migrations.AddField(
            model_name='pripadagrupi',
            name='semestar',
            field=models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='studserviceapp.Semestar'),
        ),
        migrations.AddField(
            model_name='pripadagrupi',
            name='student',
            field=models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='studserviceapp.Student'),
        ),
        migrations.AddField(
